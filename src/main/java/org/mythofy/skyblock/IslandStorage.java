...
public class IslandStorage {
    ...
    public void saveIsland(Island island) {
        ...
        String key = ownerUUID.toString();

        islandsConfig.set("islands." + key + ".homeLocation.world", island.getHomeLocation().getWorld().getName());
        islandsConfig.set("islands." + key + ".homeLocation.x", island.getHomeLocation().getX());
        islandsConfig.set("islands." + key + ".homeLocation.y", island.getHomeLocation().getY());
        islandsConfig.set("islands." + key + ".homeLocation.z", island.getHomeLocation().getZ());
        islandsConfig.set("islands." + key + ".homeLocation.yaw", island.getHomeLocation().getYaw());
        islandsConfig.set("islands." + key + ".homeLocation.pitch", island.getHomeLocation().getPitch());
        islandsConfig.set("islands." + key + ".level", island.getLevel());
        islandsConfig.set("islands." + key + ".isPublic", island.isPublic());

        plugin.saveConfig();
        plugin.getLogger().info("Island for owner UUID: " + ownerUUID + " has been saved.");
    }
